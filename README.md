...
### Cloud-Native SWE · DevOps · Backend Systems

*Designing scalable, production-ready systems — from architecture to deployment.*

[![LinkedIn](https://img.shields.io/badge/LinkedIn-angelo--lopez--abad-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/angelo-lopez-abad)
[![Email](https://img.shields.io/badge/Email-0.angeloal%40gmail.com-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:0.angeloal@gmail.com)
[![Location](https://img.shields.io/badge/Barcelona-Spain-333?style=flat-square&logo=googlemaps&logoColor=white)](#)
...
Backend-focused Software Engineer with experience designing and deploying **cloud-native, distributed systems** end-to-end. Strong advocate of **Clean Architecture** and **Domain-Driven Design**, with a DevOps mindset across the full delivery pipeline — from IaC and CI/CD to containerization and observability.

Currently working across **Python · TypeScript · AWS**, building resilient platforms that scale.
...
**Bachelor's Degree in Computer Science & Engineering** — UPC, Barcelona *(2018–2022)*
**Elective Coursework in CS & Engineering** — UOC, Barcelona *(2021–2022)*
